...
public class ProbadorLPCC4 {
	...
	public static double[] costoTerCC = {20.0, 50.0}; // costo por MWh térmico de energía del ciclo combinado para cada combustible
	...
	public static double energMaxComb1CC = 3000.0;  // energía máxima en MWh del combustible primario
	
	public static double epsilon = 0.01; 
	
	public static int cantArranques = 2;   // cantidad de tipos de arranques
	
	public static int[] durRampa = {4, 2, 2}; // cantidad de horas de rampa en que no se alzanca potencia máxima
	...
	public static void main(String[] args) {
		...
		String dirSalidas = "G:/PLA/Pla_datos/Archivos/ModeloOp/ModeladoCicloCombinado/EjemploLPSolve/prob4-28abr.lp";
...
//			demanda[h] = demMediodia;
		...
		//		[ suma en r (suma en j=Dr,�,1 (y(n,r,h-j))) ] / Dr >= x(n,h) - x(n,h-1)
		...
		// No puede haber a la vez alguna TG en alguna rampa y alguna TG en régimen CC
...
//						sb.append("z" + m + h + " <= 1");  // OJOJOJOJOJO ACA m ESTA OPERANDO EN CICLO ABIERTO ???????????
		...
		//		Para todo h
		//		suma en k (terRamkh) = suma en n(suma en r (suma en j=1,�,Dr (yn r h-j * pTerRr j)))
		sb.append("//		Potencia termica en rampas por hora \n");
		for(int h=0; h<cantHoras; h++){
			for(int k=1; k<=cantComb; k++){
