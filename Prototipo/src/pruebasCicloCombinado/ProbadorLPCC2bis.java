 ...
 *
 * ProbadorLPCC2bis is part of MOP.
 *
 ...
 * ACA AGREGO POSIBILIDAD DE ARRANQUE DE UNO O DOS TGS EN RAMPA
 *
 */

public class ProbadorLPCC2bis {
	...
	public static int[] cantArranquesPorTipo = {1, 1, 1, 1};   // cantidad de arranques de cada tipo en el d�a
	 ...
	 * 
	 * xh, h=0,..cantHoras, enteras que valen la cantidad de TGs en r�gimen en el ciclo combinado
	 * yh, h=0,..cantHoras, enteras que valen la cantidad de TGs en rampa en el ciclo combinado
	 * zh, h=0,..cantHoras, enteras que valen la cantidad de m�dulos de TG que no est�n en el ciclo y est�n en paralelo  
	 * 
	 * @param args
	 */
	...
	public static void main(String[] args) {
		...
		String dirSalidas = "G:/PLA/Pla_datos/Archivos/ModeloOp/ModeladoCicloCombinado/EjemploLPSolve/prob2bis.lp";
		...
		// No puede haber turbinas en rampa y en r�gimen a la vez 
		for(int h=0; h<cantHoras; h++){
			sb.append("x"+ h);
			for(int ia=1; ia<=cantTipArranques; ia++){
				sb.append(" + y"+ ia + h);
		...
		// Declara variables enteras xh yth zh 
		sb.append("int ");
		for(int h=0; h<cantHoras; h++){
			sb.append("x"+ h +", ");
			for(int ia=1; ia<=cantTipArranques; ia++){
			...
			sb.append("z"+ h );
			if(h!=cantHoras)sb.append(", ");
		}
		sb.append(";");
		sb.append("\n");	
		
		// Declara variables binarias iram ireg
		sb.append("bin ");
		for(int h=0; h<cantHoras; h++){
			sb.append("iram"+ h +", ");
			sb.append("ireg"+ h );
