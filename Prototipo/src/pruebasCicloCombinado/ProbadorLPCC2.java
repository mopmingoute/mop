...
public class ProbadorLPCC2 {
	...
	public static int[] cantArranquesPorTipo = {1, 1, 1, 1};   // cantidad de arranques de cada tipo en el día
	...
	public static void main(String[] args) {
		...
		// Restricción x y1 y2 solo una a lo sumo es 1
		for(int h=0; h<cantHoras; h++){
			sb.append("x"+ h);
			for(int ia=1; ia<=cantTipArranques; ia++){
				sb.append(" + y"+ ia + h);
		...
		// Entrada en régimen requiere alguna rampa previa
		double coef;
		for(int h=0; h<cantHoras; h++){
