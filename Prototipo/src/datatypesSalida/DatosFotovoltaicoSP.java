 ...
 *
 * DatosFotovoltaicoSP is part of MOP.
 *
...
public class DatosFotovoltaicoSP {
	...
	public DatosFotovoltaicoSP(String nombre, String nombreBarra, double[] potencias, int cantModDisp, double potmax,
	...
	public void imprimir() {
		System.out.println("------------------------------------------------------------------------");
		System.out.println("Generador Fotovoltaico:" + nombre);
