 ...
 *
 * CargadorResOptimEDF is part of MOP.
 *
 ...
 */
public class CargadorResOptimEDF {
	...
	public static ResOptimIncrementos devuelveResOptimIncrementos(DatosResOptimIncrementos droi){
		...
		TablaControlesDE tablaCDE = new TablaControlesDEMemoria();
	    ...
	    if (Constantes.NIVEL_CONSOLA > 1) {
		    System.out.println("Aóos: anini ="+ anini +" - anfin= " + anfin);
		    System.out.println("Cant estados: " + cantEstados +" Pasos De Stock (puntos) = " + cantPasosStock+1);
	    }
	    lecVagua.leerVagua(ruta);        
	    if (Constantes.NIVEL_CONSOLA > 1) System.out.println("TERMINA LECTURA DE VAGUA.D");
        /**
        ...
        if (Constantes.NIVEL_CONSOLA > 1) System.out.println(instanteInicial.toString());
	...
	public static void main(String[] args){
		...
		droi.setTipoSoporte(" ");
		ResOptimIncrementos resOptim = CargadorResOptimEDF.devuelveResOptimIncrementos(droi);
