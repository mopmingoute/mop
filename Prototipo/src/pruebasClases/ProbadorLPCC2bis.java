...
public class ProbadorLPCC2bis {
	 ...
	 * 
	 * xh, h=0,..cantHoras, enteras que valen la cantidad de TGs en rógimen en el ciclo combinado
	 * yh, h=0,..cantHoras, enteras que valen la cantidad de TGs en rampa en el ciclo combinado
	 * zh, h=0,..cantHoras, enteras que valen la cantidad de módulos de TG que no estón en el ciclo y estón en paralelo  
	 * 
	 * @param args
	 */
	...
	public static void main(String[] args) {
		...
		// No puede haber turbinas en rampa y en rógimen a la vez 
		for(int h=0; h<cantHoras; h++){
			sb.append("x"+ h);
			for(int ia=1; ia<=cantTipArranques; ia++){
				sb.append(" + y"+ ia + h);
