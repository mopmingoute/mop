 ...
 *
 * EstimadorPEController is part of MOP.
 *
...
import procesosEstocasticos.EstimadorMarkovDiscreto;

import java.io.File;


public class EstimadorPEController extends GeneralidadesController {
    @FXML private JFXTextField inputNombre;
    @FXML private JFXTextField inputDirEntradas;
    @FXML private JFXTextField inputNombreProcHistAsoc;
    ...
    public EstimadorPEController(Manejador parentController){
    ...
    public void initialize(){
        ...
        inputEstimar.setOnAction(actionEvent ->{
            if(EstimadorMarkovDiscreto.estimar(inputDirEntradas.getText(), inputNombre.getText(), inputNombreProcHistAsoc.getText())){
    ...
    private void loadData(){
        ...
        String dirPHistorico = inputNombreProcHistAsoc.getText();
